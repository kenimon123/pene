...
/**
 * Wrapper para conexiones que vienen del pool
 * Cuando se llama a close(), la conexión se devuelve al pool en lugar de cerrarse
 */
public class PooledConnection implements Connection {
    ...
    // Delegar todos los otros métodos a la conexión real
    @Override
